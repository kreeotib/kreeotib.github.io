...
document.addEventListener('DOMContentLoaded', () => {
     ScrollReveal.init({initialDelay: 300});
});
...
(function () {
    ...
    function onScroll() {
        ...
        const atBottom = scrolled + window.innerHeight >= document.documentElement.scrollHeight;

        bottom.classList.toggle('sticky', !atBottom);
    }
