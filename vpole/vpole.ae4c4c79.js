!function(t, e) {
    ...
    function p(t) {
        ...
        if (o.Masked) {
            ...
            const { mask: e, ...a } = t instanceof o.Masked ? {
                mask: t
    ...
    class f {
        ...
        updateControl(t) {
            const e = this.masked.unmaskedValue, s = this.masked.value, i = this.masked.rawInputValue, a = this.displayValue, u = this.unmaskedValue !== e || this.value !== s || this._rawInputValue !== i;
    ...
    class A {
        ...
        extend(t) {
            ...
            const s = this.chunks[this.chunks.length - 1], i = s && (s.stop === t.stop || null == t.stop) && t.from === s.from + s.toString().length;
        ...
        appendTo(t) {
            if (!(t instanceof o.MaskedPattern)) return new E(this.toString()).appendTo(t);
            const e = new v;
    ...
    class x {
        ...
        _appendChar(t, e) {
            ...
            const s = !0 === this.eager || "append" === this.eager, i = this.char === t && (this.isUnmasking || e.input || e.raw) && (!e.raw || !s) && !e.tail, a = new v({
                inserted: this.char,
    ...
    class b extends C {
        ...
        _forEachBlocksInRange(t, e, s) {
            ...
            if (i) {
                const t = this._mapPosToBlock(e), a = t && i.index === t.index, u = i.offset, n = t && a ? t.offset : this._blocks[i.index].displayValue.length;
    ...
    class D extends b {
        ...
        boundaries(t) {
            ...
            return a && (e = "0".repeat(i.length) + a, s = "9".repeat(i.length) + a), e = e.padEnd(this.maxLength, "0"), s = s.padEnd(this.maxLength, "9"), [
                e,
                s
            ];
        }
        doPrepareChar(t, e) {
            let s;
            return void 0 === e && (e = {}), [t, s] = super.doPrepareChar(t.replace(/\D/g, ""), e), t || (s.skip = !this.isComplete), [
                t,
                s
            ];
        }
        _appendCharRaw(t, e) {
            ...
            const s = String(this.from).padStart(this.maxLength, "0"), i = String(this.to).padStart(this.maxLength, "0"), [a, u] = this.boundaries(this.value + t);
    ...
    class y extends b {
        ...
        _update(t) {
            const { mask: s, pattern: i, blocks: a, ...u } = {
                ...y.DEFAULTS,
                ...t
    ...
    class M extends C {
        ...
        _applyDispatch(t, e, s) {
            ...
            const i = e.tail && null != e._beforeTailState ? e._beforeTailState._value : this.value, a = this.rawInputValue, u = e.tail && null != e._beforeTailState ? e._beforeTailState._rawInputValue : a, n = a.slice(u.length), r = this.currentMask, h = new v, o = null == r ? void 0 : r.state;
    ...
    M.DEFAULTS = {
        ...
        dispatch: (t, e, s, i)=>{
            ...
            const u = e.rawInputValue, n = e.compiledMasks.map((n, r)=>{
                const h = e.currentMask === n, o = h ? n.displayValue.length : n.nearestInputPos(n.displayValue.length, a.FORCE_LEFT);
    ...
    class I extends b {
        ...
        _appendCharRaw(t, e) {
            void 0 === e && (e = {});
            const s = Math.min(this.nearestInputPos(0, a.FORCE_RIGHT), this.value.length), i = this.enum.filter((e)=>this.matchValue(e, this.unmaskedValue + t, s));
            if (i.length) {
    ...
    class w extends C {
        ...
        _updateRegExps() {
            const t = "^" + (this.allowNegative ? "[+|\\-]?" : ""), e = (this.scale ? "(" + n(this.radix) + "\\d{0," + this.scale + "})?" : "") + "$";
        ...
        doPrepareChar(t, e) {
            ...
            return t && !s && (i.skip = !0), !s || this.allowPositive || this.value || "-" === s || i.aggregate(this._appendChar("-")), [
                s,
                i
            ];
        }
        ...
        _appendCharRaw(t, e) {
            ...
            const o = e.tail && e._beforeTailState ? e._beforeTailState._value : this._value, l = this._separatorsCountFromSlice(o);
    ...
    T = w, w.UNMASKED_RADIX = ".", w.EMPTY_VALUES = [
        ...C.EMPTY_VALUES,
        0
    ], w.DEFAULTS = {
        ...C.DEFAULTS,
...
//# sourceMappingURL=vpole.ae4c4c79.js.map
